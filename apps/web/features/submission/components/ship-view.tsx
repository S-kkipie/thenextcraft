...
// query reactiva) y monta el formulario, ahora envuelto por el copiloto:
// ShipCopilot inyecta el contexto (reto + empresa + jobs scrapeados) y expone
// la herramienta scrapeCompany; CopilotSidebar es la UI de chat.
